//! AION OS v2 core: deterministic contracts and capsule I/O.
...
pub use distribution_contract::{
    evaluate_distribution_contract, DistributionArtifact, DistributionChannel, DistributionContract,
...
pub use evidence::{
    seal_run, verify_linear, EvidenceChain, EvidenceContract, EvidenceRecord, EvidenceReplayAnchors,
    sha256_hex,
};
...
pub use identity::{
    global_consistency_contract_version, os_compatibility_profile, os_identity,
    os_kernel_version, os_kernel_version_from_inputs, OsCompatibilityProfile, OsIdentity,
    OsInstanceId, OsKernelVersion,
};
...
pub use observability_contract::{
    evaluate_observability_contract, ObservabilityContract, ObservabilityInput, ObservabilityResult,
...
pub use release_governance::{evaluate_deterministic_build_contract, BuildFingerprint, DeterministicBuildContract};
pub use release_signing::{sign_release_artifact, verify_release_signature, ReleaseSignature};
pub use replay_invariant_gate::{
    run_replay_invariant_gate, ReplayInvariantCheck, ReplayInvariantGate,
...
pub use security_scanning::{run_security_scans, SecurityIssue, SecurityScanConfig, SecurityScanResult};
